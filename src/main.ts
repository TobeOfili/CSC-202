...
import { NestExpressApplication } from '@nestjs/platform-express';//We need join to synthesize the directory path which will contain templates
...
async function bootstrap() {
  ...
  //create a Nest application with Express under the hoodconst app = await NestFactory.create<NestExpressApplication>(AppModule,);
...
which is the root directory for our template files*/const views = join(__dirname, '..', 'views');
